wget https://raw.githubusercontent.com/n0nvme/even-better-ls/master/ls_colors_generator.py
...
rm -rf ls.c
wget https://raw.githubusercontent.com/n0nvme/even-better-ls/master/ls.c
cd ..
./configure
make
cd src
